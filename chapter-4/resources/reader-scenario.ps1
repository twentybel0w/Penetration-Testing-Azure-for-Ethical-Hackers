...
# Deploy ARM Template
az deployment group create --name TemplateDeployment --resource-group $group --template-uri "https://raw.githubusercontent.com/twentybel0w/Penetration-Testing-Azure-for-Ethical-Hackers/main/chapter-4/resources/badtemplate.json"
